...
- **Document Processing**: Pandoc (converts uploaded docs to text for chunking/embedding)
...
# Install Pandoc (required for document processing)
brew install pandoc
...
│               ├── status/          # Health check
│               ├── knowledge-bases/ # KB CRUD, documents, entries, search
│               └── challenges/      # Includes challenges/:id/knowledge-bases/
